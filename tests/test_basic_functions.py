...
from tests.util import compare_image_files, BASELINE_DIRECTORY
...
def test_read_write(temp_output_png , orange_image: Image):
    print('start')
    # simply reads and writes a file
    baseline = os.path.join(BASELINE_DIRECTORY, 'test_read_write.png')

...
def test_feed_garbage_to_multi_image(temp_output_gif: str, orange_swirl_batch: FrameBatch):
    ...
    try:
        ...
        for i, frame in enumerate(orange_swirl_batch.frames):
            ...
            if (i % 3) == 0:
                ...
                temp_batch.add_frame(frame).add_frame(frame).add_frame(frame).add_frame(frame)

...
def test_create_gif(temp_output_gif: str, orange_swirl_batch: FrameBatch, framerate: int) -> Image:
    baseline = os.path.join(BASELINE_DIRECTORY, f'test_create_gif_framerate_{framerate}.gif')

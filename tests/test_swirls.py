...
def test_basic_swirl(temp_output_png: str, single_orange_image: Image):
...
def test_variable_swirl(temp_output_png: str, single_orange_image: Image, swirl_depth: int):
    # test variable swirl
    if swirl_depth == 0:
...
@pytest.mark.skip('rewrite')
def test_varying_variable_swirl(temp_output_png: str, single_orange_image: Image):
